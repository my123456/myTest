...
//		// Reader reader2=new InputStreamReader(new
//		// ByteArrayInputStream(title.getBytes()));
//
...
//	private static void searcher(String words, String field) throws CorruptIndexException, IOException, ParseException {
//		Path indexDir = new File(INDEX_DIR);
//		// 索引目录
//		Directory dir = FSDirectory.open(indexDir);
//		// 根据索引目录创建读索引对象
...
//		String url = "http://www.ccut.edu.cn/";
//		// 收录网站
//		addSite(url);
//		// 搜有标题带有“搜索引擎”字眼的网页
//		searcher("张德江", "title");
