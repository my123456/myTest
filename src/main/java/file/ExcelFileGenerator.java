...
// 
//    private ArrayList<String> fieldName = null; //excel数据的抬头栏，即名称栏
// 
//    private ArrayList<Object> fieldData = null; //excel导出的实际数据 
// 
...
//    public ExcelFileGenerator(ArrayList<String> fieldName, ArrayList<Object> fieldData) {
